...
const AboutUs = () =>
{
    return(
        <>
            <NavbarMain />
            <div className="container-fluid main-content" style={{ backgroundColor: "white" }}>
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>Our Inspiration</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
                        In the stirring pages of "
                        <a href="https://www.amazon.com/dp/1480952281" style={{ color: "black" }}>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>The Mission</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
                        ...
                        <ol>
                            <li style={{ color: 'black' }}>Believe.</li>
                            <li style={{ color: 'black' }}>Fight Evil.</li>
                            <li style={{ color: 'black' }}>Save Others.</li>
                        </ol>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>The Prayer of Submission</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>The Commitment</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>Our Digital Prayer Diary</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="m-1 p-1" style={{ color: 'black' }}>Join Us</h2>
                        <p className="m-1 p-1" style={{ color: 'black' }}>
