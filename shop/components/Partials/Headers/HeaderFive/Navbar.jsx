...
export default function Navbar({ className }) {
  ...
  return (
    <div className={`nav-widget-wrapper w-full bg-qh5-bwhite h-[60px] relative z-30 ${className || ""}`}>
          ...
          <div className="w-full h-full flex justify-between items-center">
            <div className="category-and-nav flex xl:space-x-7 space-x-3 items-center">
              <div className="category w-[270px] h-[53px] bg-white px-5 rounded-t-md mt-[6px] relative">
                ...
                {categoryToggle && (
                  <div className="fixed top-0 left-0 w-full h-full -z-10" onClick={toggleHandler}></div>
                )}
                <div
                      ...
                      <Link href="#">
                        <div className="flex justify-between items-center px-5 h-10 bg-white hover:bg-qh2-green transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:text-white">
                          <div className="flex items-center space-x-6">
                            <span>
                              <Image
                                src="/icons/mobile-laptop.svg" // Example image path
                                alt="Mobile & Laptops"
                                width={12}
                                height={16}
                              />
                      ...
                      <Link href="#">
                        <div className="flex justify-between items-center px-5 h-10 bg-white hover:bg-qh2-green transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:text-white">
                          <div className="flex items-center space-x-6">
                            <span>
                              <Image
                                src="/icons/gaming-entertainment.svg" // Example image path
                      ...
                      <Link href="#">
                        <div className="flex justify-between items-center px-5 h-10 bg-white hover:bg-qh2-green transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:text-white">
                          <div className="flex items-center space-x-6">
                            <span>
                              <Image
                                src="/icons/image-video.svg" // Example image path
                                alt="Image & Video"
                                width={18}
                                height={14}
                              />
